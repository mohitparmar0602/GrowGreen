    ...
    return (
        <div className="container py-12 px-4 mx-auto max-w-6xl">
            <div className="text-center mb-12">
                <h1 className="text-4xl font-bold text-green-950 dark:text-foreground mb-4">Our Trusted Suppliers</h1>
                <p className="text-slate-600 dark:text-muted-foreground max-w-2xl mx-auto">
