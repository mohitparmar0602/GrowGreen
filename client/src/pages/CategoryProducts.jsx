    ...
    return (
        <div className="container py-8 px-4">
            <div className="mb-8">
                ...
                <h1 className="text-3xl font-bold text-green-950">{displayCategory} Collection</h1>
                <p className="text-slate-600 mt-2">Explore our wide range of {displayCategory.toLowerCase()}.</p>
            </div>
                            ...
                            <CardHeader className="p-4 pb-2">
                                <div className="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p className="text-sm text-green-600 font-medium">{product.supplier}</p>
                                    </div>
                                </div>
                            </CardHeader>
