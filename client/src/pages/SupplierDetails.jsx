...
export default function SupplierDetails() {
    ...
    return (
        <div className="container py-8 px-4 mx-auto max-w-7xl">
            ...
            {/* Supplier Header */}
            <div className="bg-green-50 rounded-3xl p-8 mb-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        <h1 className="text-3xl font-bold text-green-950">{supplier.name}</h1>
                ...
                <div className="bg-white px-6 py-3 rounded-2xl shadow-sm border border-green-100">
                    <span className="block text-xs uppercase tracking-wide text-slate-500 font-bold mb-1">Total Products</span>
                    <span className="text-2xl font-bold text-green-700">{products.length} Items</span>
                </div>
            </div>

            {/* Products Grid */}
            <h2 className="text-2xl font-bold text-slate-900 mb-6">Products Offered</h2>
            ...
            {products.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {products.map(product => (
                        <Card key={product._id} className="overflow-hidden group h-full flex flex-col hover:shadow-lg transition-shadow">
